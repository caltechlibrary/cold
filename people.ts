    ...
    */
    ...
    fromObject(obj: { [key: string]: any }) {
        ...
        (obj.include_in_feeds === undefined)
            ...
            : this.include_in_feeds = obj
                .include_in_feeds as unknown as boolean;
        ...
        (obj.directory_user_id === undefined || obj.directory_user_id === "")
            ...
            : this.directory_user_id = obj
                .directory_user_id as unknown as string;
    ...
    asObject(): { [key: string]: any } {
        return {
            ...
            lcnaf: (this.lcnaf.trim() === "")
                ? ""
                : mdt.normalizeLCNAF(this.lcnaf),
