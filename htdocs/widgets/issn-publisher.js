/**
 * subjects.js implements an individual subjects display element and
 * a subjects list element.
 */
"use strict";
...
/* DisplaySubject component extends HTMLSpanElement */
class DisplaySubject extends HTMLElement {
    constructor() {
        super();
...
export { DisplaySubject };
window.customElements.define('display-subject', DisplaySubject);
