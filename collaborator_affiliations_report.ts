/**
 * collaborator_affiliations_report.ts provides the browser side JavaScript for interacting with the collaborator affiliations reports by providing a field search form
 ...
 *
 * ~~~HTML
 * <div id="collaborator_affiliations_report"></div>
 *
 * <noscript>JavaScript required for the collaborator affiliations report</noscript>
 *
 * <script type="module">
 *   import { CollaboratorAffiliationsReportUI } from "./modules/collaborator_affiliations_report.js";
 *   const baseUrl = URL.parse(window.location.href);
 *   baseUrl.pathname = baseUrl.pathname.replace(/collaborator_affiliations_report.html$/g, '');
 *   baseUrl.search = "";
 *   const reportElement = document.getElementById("collaborator_affiliations_report");
 *   window.addEventListener('DOMContentLoaded', (event) => {
 *     const CollaboratorAffiliationsReportUI = new CollaboratorAffiliationsReportUI({
 *         baseUrl: baseUrl,
...
export class CollaboratorAffiliationsReportUI {
  ...
  constructor(
    ...
    <p>
        <section class="collaborator-affiliations-report-results" id="collaborator-affiliations-report-results"></section>
    </p>
`;
